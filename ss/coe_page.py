...
ASSETS_PATH = OUTPUT_PATH / Path(r"E:\FinalProject\build\assets\frame17")

def relative_to_assets(path: str) -> Path:
    return ASSETS_PATH / Path(path)

class CoePage(Frame):
    def __init__(self, master, show_main_menu_func, switch_to_menu_back):
        ...
        self.html_frame.load_website("http://eng.rmutsv.ac.th/engineeri/th/computer")
