...
ASSETS_PATH = OUTPUT_PATH / Path(r"E:\FinalProject\build\assets\frame5")

def relative_to_assets(path: str) -> Path:
    return ASSETS_PATH / Path(path)

class CePage(Frame):
    def __init__(self, master, show_main_menu_func, switch_to_menu_next):
        ...
        image_1 = canvas.create_image(640.0, 370.0, image=self.image_image_1)
        ...
        self.html_frame.load_website("http://eng.rmutsv.ac.th/engineeri/th/civil")
