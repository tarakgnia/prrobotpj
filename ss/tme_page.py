...
ASSETS_PATH = OUTPUT_PATH / Path(r"E:\FinalProject\build\assets\frame13")
...
class TmePage(Frame):
    def __init__(self, master, show_main_menu_func, switch_to_menu_next, switch_to_menu_back):
        ...
        self.html_frame.load_website("http://eng.rmutsv.ac.th/engineeri/th/mechanicaltechnology")
